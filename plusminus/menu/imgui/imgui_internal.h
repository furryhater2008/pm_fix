...
enum ImGuiItemFlags_
{
    ...
    ImGuiItemFlags_Inputable = 1 << 8,// false    // [BETA] Represent a mixed/indeterminate value, generally multi-selection where values differ. Currently only supported by Checkbox() (later should support all sorts of widgets)
...
enum ImGuiItemStatusFlags_
{
    ...
    ImGuiItemStatusFlags_FocusedByTabbing = 1 << 8 // Only valid if ImGuiItemStatusFlags_HasDeactivated is set.
...
struct IMGUI_API ImGuiInputTextState
{
    ...
    int         GetUndoAvailCount() const { return Stb.und0x20.undo_point; }
    int         GetRedoAvailCount() const { return STB_TEXTEDIT_UND0x20COUNT - Stb.und0x20.redo_point; }
...
struct ImGuiContext
{
    ...
    ImU32                   ColorEditLastColor1;                 // RGB value with alpha set to 0.
